...
//생성자를 만들지 않았다면
//자바에서 제공하는 기본 생성자가 호출 되는데,
//기본형 데이터타입의 필드는 0
//참조형 데이터 타입 필드는 null로 초기화

//생성자는 우리가 만들어 줄 수 있는데
//주의할 점은 파라미터가 있는 생성자만 만들면
//더 이상 파라미터가 없는 생성자는 만들 수 없다.
//만약 파라미터 있는 생성자 없는 생성자 2개 모두 필요하면
//둘 다 만들어줘야 한다.
